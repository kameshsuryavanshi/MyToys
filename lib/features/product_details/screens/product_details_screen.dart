...
import 'package:mytoys/common/widgets/stars.dart';
...
import 'package:mytoys/features/product_details/services/product_details_services.dart';
...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  Widget build(BuildContext context) {
    double sum = widget.product.price;
